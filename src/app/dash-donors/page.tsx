...
//   const [cardMode, setCardMode] = useState<"card" | "photo" | "history">(
//     "card",
//   );
...
export default function DonorDashboard() {
  ...
  const [cardMode, setCardMode] = useState<
    "profile" | "photo" | "history" | "donate"
  >("profile");
  console.log("📢 Card mode atual:", cardMode);
            ...
            {athletes.length > 1 && (
              <>
                ...
                <button
                  ...
                  className={`bg-primary absolute top-1/2 -left-4 -translate-y-1/2 rounded-full p-2 shadow-md transition ${cardMode !== "profile" ? "pointer-events-none opacity-30" : "hover:bg-black"} `}
                >
                  <ChevronLeft className="h-4 w-4 text-white" />
                </button>
                ...
                <button
                  ...
                  className={`bg-primary absolute top-1/2 -right-4 -translate-y-1/2 rounded-full p-2 shadow-md transition ${cardMode !== "profile" ? "pointer-events-none opacity-30" : "hover:bg-black"} `}
                >
                  <ChevronRight className="h-4 w-4 text-white" />
                </button>
              </>
