...
const LoginForm = () => {
  ...
  const handleSubmit = async (values: z.infer<typeof loginSchema>) => {
    ...
    try {
      ...
      if (!user) {
        toast.error("Usuário não cadastrado. Crie sua conta primeiro.");
        ...
        <Form {...form}>
          ...
          >
            ...
            <Button
              variant="outline"
              type="button"
              className={`mt-2 flex w-full items-center justify-center bg-transparent transition-opacity ${
                isGoogleLoading ? "cursor-not-allowed opacity-60" : ""
              }`}
