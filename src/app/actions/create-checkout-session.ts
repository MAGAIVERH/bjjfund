...
// import { headers } from "next/headers"; // vamos awaitar abaixo
...
//   campaignId?: string,
// ) {
//   // ✅ pegue os headers reais da request (no seu setup, headers() é Promise)
//   const h = await headers();

//   // ✅ passe esses headers para o Better Auth para identificar o usuário logado
...
//   // 💳 cria a sessão no Stripe com metadata completa (ESSENCIAL para o webhook)
...
//       athleteId,
//       athleteName,
//       ...(campaignId ? { campaignId } : {}), // ✅ só inclui se existir
//     },
//     line_items: [
//       {
//         price_data: {
